...
<figure class="one">
	<img style="border: none;" src="/images/figures/2014041601.png">
	<figcaption>NX=NL+3;NY=NW+3<br/>$\int_sX_k(\xi)G_{qj}(t,\xi)~d\xi$<br/>k=(iw-1)*NL+il</figcaption>
</figure>
...
\begin{cases}
    \frac{1}{8}\Delta s^3    & s_j-1.5\Delta s  & ; ave &  \frac{1}{4}\Delta s^3  \\
    \frac{23}{8}\Delta s^3   & s_j-0.5\Delta s  & ; ave &  \frac{11}{4}\Delta s^3 \\
    \frac{23}{8}\Delta s^3   & s_j+0.5\Delta s  & ; ave &  \frac{11}{4}\Delta s^3 \\
    \frac{1}{8}\Delta s^3    & s_j+1.5\Delta s  & ; ave &  \frac{1}{4}\Delta s^3  \\
  \end{cases} \\  
\end{aligned}
