...
\therefore \quad & ~\\
\mathbf{a^\star} = &\mathbf{E}(\mathbf{a})=\left(\mathbf{H}^T\Sigma_d^{-1}\mathbf{H}+\mathbf{S}^T\Sigma_s^{-1}\mathbf{S}\right)^{-1} \left(\mathbf{H}^T\Sigma_d^{-1}\mathbf{d}\right)\\
...
&= var(\mathbf{H}^T\Sigma_d^{-1}\mathbf{d})+var(\mathbf{S}^T\Sigma_s^{-1}\mathbf{0}) \\
&=\mathbf{H}^T\Sigma_d^{-1}\Sigma_d\Sigma_d^{-1}\mathbf{H}+ \mathbf{S}^T\Sigma_s^{-1}\Sigma_s\Sigma_s^{-1}\mathbf{S} \quad;\quad cov(\mathbf{d,0})=0\\
...
<div>$$
\begin{aligned}
\Sigma_a=\left(\mathbf{H}^T\Sigma_d^{-1}\mathbf{H}+\mathbf{S}^T\Sigma_s^{-1}\mathbf{S}\right)^{-1}
\end{aligned}
$$</div>
