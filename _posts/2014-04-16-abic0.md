...
<div  style="width:100% ; height:174px;overflow-x:auto;overflow-y:hidden">
 ...
 <div style="width:330px; height:75px;float:left;">$$ m_\xi  \iff \int \sum_{k=1}^K \sum_{l=1}^L a_{qkl}X_k\left(\xi\right)T_l\left(\tau-\tau_k\right)~d\tau $$ </div> 
 ...
 <div style="width:330px; height:75px;float:left;">$$ m_\tau  \iff \int \sum_{k=1}^K \sum_{l=1}^L a_{qkl}X_k\left(\xi\right)T_l\left(\tau-\tau_k\right)~d\xi $$ </div> 
