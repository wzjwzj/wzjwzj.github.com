...
<div class="e_content" style="position: relative; left: 6px; top: 6px; margin-bottom: 18px;width:9em">
  ...
  <div style="position: relative; left: -3px; top: -3px; background: #B8B6B8;">
    <img src="/gallery/golm/thumbs/4.jpg" style="width: calc(100% - 5px - 5px - 2px);padding: initial;border: initial; vertical-align: middle;padding: 5px;background-color: white;border: 1px solid #b3b3b3;" alt="golm">
  </div>
  </div>
  </div>
</div>
