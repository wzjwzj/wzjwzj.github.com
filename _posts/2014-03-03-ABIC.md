...
\Lambda 0 &= 
  \begin{cases}
    (s+2\Delta s)^3 = s^3+6\Delta s s^2  + 12 \Delta s^2 s + 8 \Delta s^3       &  (-2 \Delta s,  - \Delta s)\\
    -3 s^3 -6 \Delta s s^2 + 4 \Delta s^3                                       &  (-  \Delta s ,  0        )\\  
     3 s^3 -6 \Delta s s^2 + 4 \Delta s^3                                       &  (  0 ,  \Delta s       )\\  
    (2\Delta s-s)^3 = -s^3+6\Delta s s^2  - 12 \Delta s^2 s + 8 \Delta s^3      &  (-2 \Delta s,  - \Delta s)
  \end{cases} \\  
\Lambda 1 &= 
  \begin{cases}
    3 s^2 + 12 \Delta s s + 12 \Delta s^2       &  (-2 \Delta s,  - \Delta s)\\
    -9 s^2 -12 \Delta s s                       &  (-  \Delta s ,  0        )\\  
     9 s^2 -12 \Delta s s                       &  (  0 ,  \Delta s       )\\  
    -3 s^2 +12 \Delta s s - 12 \Delta s^2       &  (-2 \Delta s,  - \Delta s)
  \end{cases} \\  
\Lambda 2 &= 
  \begin{cases}
    6 s + 12 \Delta s        &  (-2 \Delta s,  - \Delta s)\\
    -18 s -12 \Delta s       &  (-  \Delta s ,  0        )\\  
     18 s -12 \Delta s       &  (  0 ,  \Delta s       )\\  
    -6 s^2 +12 \Delta s      & \hspace{12pt} (-2 \Delta s,  - \Delta s)
  \end{cases} \\  
\end{aligned}
</script>
